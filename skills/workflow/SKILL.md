...
> "Do you want to implement these tasks locally now, or should I create Jira tickets?"

- **Local** → proceed to Step 4
- **Jira** → follow the task-breakdown skill's Jira integration phase, then stop
...
If all stages are `confirmed` and the user wants changes, follow the Revision flow (Step 5).
